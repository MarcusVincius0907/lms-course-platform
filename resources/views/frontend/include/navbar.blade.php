                                    ...
                                    <div class="notification-wrap d-flex align-items-center ml-3">
                                        <div class="notification-item mr-3 cart_item">
                                            ...
                                            <div id="mySidebar" class="cart-sidebar">
                                                ...
                                                <div class="cart_sidebar">
                                                    <input id="cartImg" name="cartImg" type="hidden" value="{{ assetC('frontend/images/empty_cart.png') }}">
                                                    <ul id="cartAppend">
                                                        <img src="{{ assetC('frontend/images/empty_cart.png') }}" class="w-100"  alt="">
                                                    </ul>
                                                        ...
                                                        <li>
                                                            ...
                                                            @empty
                                                                ...
                                                                <div class="content text-center no-notify">
                                                                    <img src="{{ assetC('frontend/images/notify.png') }}" class="w-100" alt="">
                                                                </div>
                                        ...
                                        <div class="notification-item mr-3 wishlist_btn">
                                            ...
                                            <div id="wishSidebar" class="cart-sidebar">
                                                ...
                                                <div class="cart_sidebar">
                                                    <input id="wishtImg" name="wishImg" type="hidden" value="{{ assetC('frontend/images/wishlist.png') }}">
                                                    <ul id="wishlistAppend">
                                                        <img src="{{ assetC('frontend/images/wishlist.png') }}" class="w-100" alt="">
                                                    </ul>
                                                    <div id="cartBtn">
                                            ...
                                            <div class="dropdown">
                                                <button
                                                    ...
                                                    <img src="{{ \Illuminate\Support\Facades\Auth::user()->image == null
                                                             ? assetC('frontend/images/student.png')
                                                    ...
                                                    <div class="mess-dropdown">
                                                        ...
                                                        <div class="mess__body">
                                                            <ul class="list-items">
                                                                ...
                                                                <li class="mb-0">
                                                                    <a href="{{route('my.certificates')}}" class="d-block">
                                                                        <i class="la la-certificate"></i> Meus Certificados
                                                                    </a>
                                                                </li>
                            ...
                            <div class="side-menu-wrap">
                                ...
                                @guest
                                    ...
                                    <div class="side-btn-box">
                                        <a style="margin-bottom: 10px;" href="{{ route('login') }}" class="theme-btn">@translate(Login)</a>
                                        <span>ou</span>
