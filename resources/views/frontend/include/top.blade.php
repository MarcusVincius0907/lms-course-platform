                        ...
                        <div class="header-right-info">
                            <ul class="social-profile d-flex align-items-center social-margin">
                                @if(getSystemSetting('type_fb')->value != null)
                                    <li><a  class="d-flex align-items-center justify-content-center" href="{{getSystemSetting('type_fb')->value}}" target="_blank"><i
                                                class="fa fa-facebook" style="font-size:18px"></i></a></li>
                                @endif

                                @if(getSystemSetting('type_tw')->value != null)
                                    <li><a class="d-flex align-items-center justify-content-center" href="{{getSystemSetting('type_tw')->value}}" target="_blank"><i
                                                class="fa fa-instagram" style="font-size:22px"></i></a></li>
                                @endif

                                @if(getSystemSetting('type_google')->value != null)
                                    <li><a class="d-flex align-items-center justify-content-center" href="{{getSystemSetting('type_google')->value}}" target="_blank"><i
                                                class="fa fa-whatsapp" style="font-size:22px"></i></a></li>
                                @endif
                            </ul>
                        </div>
