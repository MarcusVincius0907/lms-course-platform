...
@section('content')
    ...
    <section class="course-dashboard">
                                        ...
                                        <div class="lecture-overview-item">
                                            <div class="lecture-overview-stats-wrap d-flex ">
                                                <div class="lecture-overview-stats-item">
                                                    <h3 class="widget-title font-size-16">Informações</h3>
                                                </div>
                                                <div class="lecture-overview-stats-item">
                                                    <ul class="list-items">
                                                        <li><span>@translate(Skill level):</span>{{ course_level($s_course->level) }}
                                                        </li>
                                                        <li>
                                            ...
                                            <div class="lecture-overview-stats-wrap">
                                                <div class="lecture-overview-stats-item">
                                                    <div
                                                        ...
                                                        <div class="lecture-owner-avatar">
                                                            <img
                                                                src="{{ \Illuminate\Support\Facades\Auth::user()->image == null ? assetC('uploads/user/user.png') : filePath(\Illuminate\Support\Facades\Auth::user()->image) }}">
                                                        </div>
                                            ...
                                            <div class="mobile-course-menu">
                                                <div class="course-dashboard-side-content">
                                                    <div class="accordion course-item-list-accordion"
                                                        ...
                                                        <div class="text-center" id="btnGetCertificate">
                                                            {{-- @if(\App\Http\Controllers\FrontendController::seenCourse($enroll->first()->id,$s_course->id) == number_format(100)) --}}
                                                            <div class="pb-3" style="max-width: 310px;margin: auto;">O seu certificado está salvo em "Meus Certificados", mas você também pode emiti-lo por aqui</div>
                                                            <a href="{{route('certificate', ['course_id' => $s_course->id])}}" target="_blank" class="btn btn-success" > Emitir Certificado</a>
                                                            {{-- @endif --}}
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <input type="hidden" id="progressUrl" value="{{route('progress', ['id'=>$enroll->first()->id, 'course_id' => $s_course->id])}}">
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        function courseProgress(){
            var url = $('#progressUrl').val();
            let progress = $('.progress');
            let progressValue = $('.progress-value > div');
            let btnGetCertificate = $('#btnGetCertificate');
            ...
            $.ajax({
                ...
                method: 'get',
                success: function (result) {
                    progress.attr('data-percentage', result.progress);
                    progressValue.html(`${result.progress} % <br> completado`);
        ...
        function contentData(id) {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if(result && result.certificateWasCreated){
                        Swal.fire(
                            'Parabéns!',
                            'Você finalizou esse curso e agora pode emitir seu certificado!',
                            'success'
                        )
                    }
                }
