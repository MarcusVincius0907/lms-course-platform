...
=================================-->
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 d-flex justify-content-center">
                                                <a target="blank" href="https://www.youtube.com/watch?v=xpWMpJwvgn8" class="theme-btn line-height-40 text-capitalize">Sobre nós</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
   ...
   ======================================-->
                                ...
                                @foreach($latestCourses as $l_course)
                                    <div class="card-item card-preview"
                                        ...
                                        <div class="card-content">
                                            <p class="card__label">
                                                <span class="card__label-text">{{course_level($l_course->level)}}</span>
                                                @auth()
                                                    <a href="#!"
                                                    ...
                                                    <div class="column-td-half">
                                                        <div class="card-item card-preview"
                                                            ...
                                                            <div class="card-content">
                                                                <p class="card__label">
                                                                                <span
                                                                                    class="card__label-text">{{course_level($course->level)}}</span>
                                                                    @auth()
                                                                        <a href="#!"
                            ...
                            <div class="course-carousel">
                                @foreach($trading_courses as $t_courses)
                                    <div class="card-item card-preview"
                                        ...
                                        <div class="card-content">
                                            <p class="card__label">
                                                <span class="card__label-text">{{course_level($t_courses->level)}}</span>
                                                @auth()
                                                    <a href="#!"
    ...
    <!-- ================================
           START FUNFACT AREA
    ================================= -->
    <section class=" section-bg funfact-area text-center overflow-hidden padding-top-85px padding-bottom-85px">
        <div class="container">
            <div class="row">
    ...
    <section class=" p-4">
        ...
        <div id="owl-carousel-partner" class="owl-carousel container-carousel">
            <div class="item-carousel"><a target="_blank" href="http://www.abed.org.br/site/pt/"><img src="{{assetC('frontend/images/partners/abed.jpg')}}" /></a></div>
            <div class="item-carousel"><a target="_blank" href="https://missoesnoroeste.org/"><img src="{{assetC('frontend/images/partners/instituto missoes - fundo branco.png')}}" /></a></div>
            <div class="item-carousel"><a target="_blank" href="https://www.adventistas.org/pt/"><img src="{{assetC('frontend/images/partners/Uniao-Central-Brasileira-da-IASD.png')}}" /></a></div>
            <div class="item-carousel"><a target="_blank" href="https://agilspotpay.com.br/"><img src="{{assetC('frontend/images/partners/AgilSpotPay.png')}}" /></a></div>
            <div class="item-carousel"><a target="_blank" href="https://www.instagram.com/projetovivermelhorofc/?hl=pt-br"><img src="{{assetC('frontend/images/partners/vivermelhor.jpg')}}" /></a></div>
            <div class="item-carousel"><a target="_blank" href="https://www.unasp.br/"><img src="{{assetC('frontend/images/partners/LOGO-UNASP-_AZUL-CENTRALIZADO-300x84.png')}}" /></a></div>
            <div class="item-carousel"><a target="_blank" href="https://vimeo.com/"><img src="{{assetC('frontend/images/partners/vimeo.png')}}" /></a></div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-heading">
                        ...
                        <h2 class="section__title">@translate(Packages) {{getSystemSetting('type_name')->value}} @translate(Available) </h2>
                        <span class="section-divider"></span>
                    </div><!-- end section-heading -->
                </div><!-- end col-md-12 -->
            </div><!-- end row -->
