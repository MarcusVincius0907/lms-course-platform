            ...
            <form action="{{route('blog.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="custom-file">
                        ...
                        <input name="icon" class="icon" type="hidden" value="">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <textarea required="required" class="form-control summernote @error('desc') is-invalid @enderror" name="desc" rows="5">{{ old('desc') }}</textarea>
...
@stop
@section('page-script')
    <script type="text/javascript" src="{{ assetC('assets/js/custom/course.js') }}"></script>
@stop
