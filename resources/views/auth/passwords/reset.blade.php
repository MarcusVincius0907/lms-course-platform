    ...
    @if(themeManager() == 'rumbok')
        ...
        <section class="breadcrumb-section">
            <div class="breadcrumb-shape">
                <img src="{{assetC('asset_rumbok/images/round-shape-2.png')}}" alt="shape"
                     class="hero-round-shape-2 item-moveTwo">
                <img src="{{assetC('asset_rumbok/images/plus-sign.png')}}" alt="shape"
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="login-image">
                            <img src="{{assetC('asset_rumbok/images/login-image.jpg')}}" alt="image">
                        </div>
                    </div>
                    <div class="col-lg-6">
                                ...
                                <div class="card-box-shared-body contact-form-action">
                                    <form method="POST" action="{{ route('password.update') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="">
                                                <input id="email" type="email"
                                                       class="form-control @error('email') is-invalid @enderror inputResultResetPassword"
                                        ...
                                        <script>
                                            const inputResultResetPassword = document.querySelector('.inputResultResetPassword');
                                            inputResultResetPassword.value = localStorage.getItem('resetPasswordEmail');
                                        </script>
