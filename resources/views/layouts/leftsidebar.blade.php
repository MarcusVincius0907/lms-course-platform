                        ...
                        <ul class="vertical-menu">
                            ...
                            <li class="{{request()->is('dashboard/course*')
                                ...
                                <a href="javaScript:void();">
                                    ...
                                    <span>Cursos @if(\Illuminate\Support\Facades\Auth::user()->user_type == "Admin")
                                            <sup
                                ...
                                <ul class="vertical-submenu">
                                    @if(\Illuminate\Support\Facades\Auth::user()->user_type != "Admin")
                                        ...
                                        <li><a href="{{route('course.create')}}"
                                               class="{{request()->is('dashboard/course/create*') ?'active':null}}">Novo Curso</a></li>
                                    @else
                                        {{-- admin's Nav --}}
                                    ...
                                    @endif
                                        ...
                                        <li><a href="{{route('course.index')}}"
                                           class="{{request()->is('dashboard/course/index*') ?'active':null}}">Todos os Cursos @if(\Illuminate\Support\Facades\Auth::user()->user_type == "Admin")
                                                <sup
                            ...
                            @if(\Illuminate\Support\Facades\Auth::user()->user_type == "Admin")
                                ...
                                <li class="{{request()->is('dashboard/corporation*')}}">
                            ...
                            @if ( \Illuminate\Support\Facades\Auth::user()->user_type == "Instructor")
                                ...
                                <li class="{{request()->is('dashboard/coupon*')
                                    ...
                                    <a href="javascript:;">
                                        ...
                                        <span>Gerenciador de Cupons</span><i
                                            class="feather icon-chevron-right"></i>
                                    </a>
                                    <ul class="vertical-submenu">
                                        <li>
                                            <a href="{{route('coupon.index')}}"
                                               class="{{request()->is('dashboard/coupon/index')
                                                    ?'active':null}}">
                                                Todos os Cupons
                                            </a>
                                        </li>
                            ...
                            @if(\Illuminate\Support\Facades\Auth::user()->user_type == "Instructor")
                                ...
                                <li><a href="{{route('instructor.earning')}}"
                                       class="{{request()->is('dashboard/instructor*') ?'active':null}}">
                                        <i class="fa fa-history"></i> <span>Ganho do Instrutor </span>
                                    </a>
                                </li>
                                ...
                                <li class="{{request()->is('dashboard/affiliate*') ? 'active' : null}}">
                                    ...
                                    <ul class="vertical-submenu">
                                        ...
                                        <li><a href="{{route('affiliate.request.list')}}"
                                               class="{{request()->is('dashboard/affiliate/index') ?'active':null}}">Solicitações
                                        ...
                                        <li><a href="{{route('affiliate.payment.request')}}"
                                               class="{{request()->is('dashboard/affiliate/payment*') ?'active':null}}">Requerimento de Pagamento
                            ...
                            @if(\Illuminate\Support\Facades\Auth::user()->user_type == "Admin")
                                ...
                                <li><a href="{{route('admin.earning.index')}}"
                                       class="{{request()->is('dashboard/admin*') ?'active':null}}">
                                        <i class="fa fa-history"></i> <span>Ganho do admin</span>
                                    </a>
                                </li>
                                ...
                                <ul class="vertical-submenu">
                                    @if(\Illuminate\Support\Facades\Auth::user()->user_type == "Admin")
                                        <li><a href="{{route('app.setting')}}"
                                               class="{{request()->is('dashboard/app*') ?'active':null}}">Gateway config</a></li>
                                        <li><a href="{{route('currencies.index')}}"
                                               class="{{request()->is('dashboard/currency*') ?'active':null}}">Moeda
                                                Config.</a>
                                        </li>
                                        <li><a href="{{route('language.index')}}"
                                               class="{{request()->is('dashboard/language*') ?'active':null}}">Idioma
                                                Config. </a></li>
                                        <li><a href="{{route('smtp.create')}}"
                                               class="{{request()->is('dashboard/smtp*') ?'active':null}}">SMTP Config.</a></li>

                                        <li><a href="{{route('sliders.index')}}"
                                               class="{{request()->is('dashboard/slider*') ?'active':null}}"> Slider Config.</a></li>
                                        ...
                                        <li><a href="{{route('site.setting')}}"
                                               class="{{request()->is('dashboard/site*') ?'active':null}}"> Empresa Config.</a></li>

                                        <li><a href="{{route('other.setting')}}"
                                               class="{{request()->is('dashboard/other*') ?'active':null}}"> Outros
                                                Config. </a></li>
                                    ...
                                    @else
                                        ...
                                        <li><a href="{{route('account.create')}}"
                                               class="{{request()->is('dashboard/account*') ?'active':null}}">Configuração de Pagamento
                                            </a>
                                        </li>
                                    @endif
                                </ul>
