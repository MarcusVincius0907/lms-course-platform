                    ...
                    <li class="list-inline-item">
                        <div class="topbar-toggle-icon">
                            <a class="topbar-toggle-hamburger" href="javascript:void();">
                                <img src="{{ assetC('assets/images/svg-icon/horizontal.svg') }}"
                                     class="img-fluid menu-hamburger-horizontal" alt="horizontal">
                                <img src="{{ assetC('assets/images/svg-icon/verticle.svg') }}"
                    ...
                    <li class="list-inline-item">
                        <div class="menubar">
                            <a class="menu-hamburger" href="javascript:void();">
                                <img src="{{ assetC('assets/images/svg-icon/menu.svg') }}"
                                     class="img-fluid menu-hamburger-collapse" alt="collapse">
                                <img src="{{ assetC('assets/images/svg-icon/close.svg') }}"
...
<div class="topbar">
    ...
    <div class="row align-items-center">
        ...
        <div class="col-md-12 align-self-center">
            ...
            <div class="infobar">
                <ul class="list-inline mb-0">
                    <li hidden class="list-inline-item">
                                        ...
                                        <a class="dropdown-item" href="{{route('language.change')}}"
                                           onclick="event.preventDefault();
                                            ...
                                            <img width="25" height="auto"
                                                 src="{{ assetC("uploads/lang/". $language->image) }}" alt=""/>
                                            {{$language->name}}</a>
                            ...
                            <div class="dropdown show">
                                <a class="dropdown-toggle infobar-icon" href="javascript:void()" role="button"
                                   ...
                                   aria-expanded="true"><img
                                        src="{{ assetC('assets/images/svg-icon/notifications.svg') }}" class="img-fluid"
                                        alt="notifications">
                            ...
                            <div class="dropdown">
                                <a class="dropdown-toggle" href="#" role="button" id="profilelink"
                                   data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <img
                                        src="{{ \Illuminate\Support\Facades\Auth::user()->image != null ? filepath(\Illuminate\Support\Facades\Auth::user()->image)  : assetC('/assets/images/users/profile.svg')}}"
                                        ...
                                        <ul class="list-unstyled mb-0">
                                            ...
                                            @if(\Illuminate\Support\Facades\Auth::user()->user_type == "Instructor")
                                                <li class="media dropdown-item">
                                                    <a href="{{ route("instructors.edit",Illuminate\Support\Facades\Auth::user()->id) }}"
                                                       class="profile-icon">
                                                        <img src="{{assetC('assets/images/svg-icon/crm.svg')}}"
                                            ...
                                            <li class="media dropdown-item">
                                                ...
                                                <a href="{{route('logout')}}"
                                                   ...
                                                   class="profile-icon">
                                                    <img src="{{assetC('assets/images/svg-icon/logout.svg')}}"
