...
Route::group(['middleware' => ['installed', 'checkBackend', 'auth', 'activity'], 'prefix' => 'dashboard'], function () {
    ...
    //Coupon
    Route::get('coupon/index', 'Module\CouponController@index')->name('coupon.index');
    Route::get('coupon/create', 'Module\CouponController@create')->name('coupon.create');
    Route::post('coupon/store', 'Module\CouponController@store')->name('coupon.store');
    Route::get('coupon/published', 'Module\CouponController@published')->name('coupon.published');
    Route::get('coupon/edit/{id}', 'Module\CouponController@edit')->name('coupon.edit');
    Route::post('coupon/update', 'Module\CouponController@update')->name('coupon.update');
    Route::get('coupon/destroy/{id}', 'Module\CouponController@destroy')->name('coupon.destroy');

    //Corporation
    Route::get('corporation/index', 'Module\CorporationController@index')->name('corporation.index');
    Route::get('corporation/create', 'Module\CorporationController@create')->name('corporation.create');
    Route::post('corporation/store', 'Module\CorporationController@store')->name('corporation.store');
    Route::get('corporation/published', 'Module\CorporationController@published')->name('corporation.published');
    Route::get('corporation/edit/{id}', 'Module\CorporationController@edit')->name('corporation.edit');
    Route::post('corporation/update', 'Module\CorporationController@update')->name('corporation.update');
    Route::get('corporation/destroy/{id}', 'Module\CorporationController@destroy')->name('corporation.destroy');
    Route::get('corporation/students/{corporation_id}', 'Module\CorporationController@students')->name('corporation.students');
    Route::get('corporation/courses/{corporation_id}', 'Module\CorporationController@courses')->name('corporation.courses');
    ...
    Route::get('packages/published', 'Module\PackageController@published')->name('packages.published');
