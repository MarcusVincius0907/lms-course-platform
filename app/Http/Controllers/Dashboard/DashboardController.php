...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        if (Auth::user()->user_type == "Admin") {
            ...
            //Instructor Earning
            //this mount earning
            $this_earning = InstructorEarning::where('user_id', auth()->user()->id)->whereBetween('created_at', [$this_start, $this_end])->sum('will_get');
            
            //previous mount earning
            $prev_earning = InstructorEarning::where('user_id', auth()->user()->id)->whereBetween('created_at', [$prev_start, $prev_end])->sum('will_get');
            
            //total earning
            $total_earning = InstructorEarning::where('user_id', auth()->user()->id)->sum('will_get');
