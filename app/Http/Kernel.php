...
use App\Http\Middleware\CheckCorporationStudent;
...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        ...
        'api' => [
            'throttle:300,1', //todo::can increase response call here // default: 60
            \Illuminate\Routing\Middleware\SubstituteBindings::class,
        ],
    ];
    ...
    protected $routeMiddleware = [
        ...
        'checkCorpStudent'=> CheckCorporationStudent::class
    ];
}
