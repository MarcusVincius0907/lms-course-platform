...
class RouteServiceProvider extends ServiceProvider
{
    ...
    /* mapPagarRoutes Route */

    protected function mapPagarRoutes()
    {
            Route::middleware('web')
                ->namespace($this->namespace)
                ->group(base_path('routes/pagar.php'));
    }

    protected function mapCorporationRoutes()
    {
            Route::middleware('web')
                ->namespace($this->namespace)
                ->group(base_path('routes/corporationStudent.php'));
    }
