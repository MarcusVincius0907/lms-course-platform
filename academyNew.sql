...
--
-- Host: 127.0.0.1
-- Tempo de geração: 15-Fev-2022 às 17:49
...
--
-- Estrutura da tabela `admin_earnings`
--
...
--
-- Estrutura da tabela `affiliate_payments`
--
...
--
-- Estrutura da tabela `api_password_resets`
--
...
--
-- Estrutura da tabela `certificate_stores`
--
...
--
-- Extraindo dados da tabela `certificate_stores`
--
...
--
-- Estrutura da tabela `class_contents`
--
...
--
-- Extraindo dados da tabela `class_contents`
--
...
--
-- Estrutura da tabela `course_comments`
--
...
--
-- Estrutura da tabela `course_purchase_histories`
--
...
--
-- Estrutura da tabela `forum_post_views`
--
...
--
-- Estrutura da tabela `helpful_answers`
--
...
--
-- Extraindo dados da tabela `instructors`
--
...
--
-- Estrutura da tabela `instructor_accounts`
--
...
--
-- Estrutura da tabela `instructor_earnings`
--
...
--
-- Estrutura da tabela `instructor_subscription_earnings`
--
...
--
-- Estrutura da tabela `instructor_subscription_payments`
--
...
--
-- Estrutura da tabela `know_abouts`
--
...
--
-- Extraindo dados da tabela `know_abouts`
--
...
(4403, 'Viewed cursos', 'Guest', NULL, 'http://localhost/academyNew/cursos', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4758.82 Safari/537.36', 'pt-BR,pt;q=0.9,en-US;q=0.8,en;q=0.7', 'http://localhost/academyNew/', 'GET', '2022-02-15 16:42:51', '2022-02-15 16:42:51', NULL),
(4404, 'Viewed cursos', 'Guest', NULL, 'http://localhost/academyNew/cursos?cost=paid&instructor=&slug=web-development1', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4758.82 Safari/537.36', 'pt-BR,pt;q=0.9,en-US;q=0.8,en;q=0.7', 'http://localhost/academyNew/cursos', 'GET', '2022-02-15 16:42:57', '2022-02-15 16:42:57', NULL);

-- --------------------------------------------------------

--
-- Estrutura da tabela `massages`
--
...
--
-- Estrutura da tabela `media_managers`
--
...
--
-- Extraindo dados da tabela `media_managers`
--
...
(74, '2017_10_10_10000_create_point_transactions_table', 9),
(75, '2020_03_20_123529_create_payments_pagar_table', 9),
(76, '2020_03_20_123530_create_enrollments_table', 9);

-- --------------------------------------------------------

--
-- Estrutura da tabela `notification_users`
--
...
--
-- Estrutura da tabela `package_purchase_histories`
--
...
--
-- Extraindo dados da tabela `package_purchase_histories`
--
...
--
-- Estrutura da tabela `payments_pagar`
--

CREATE TABLE `payments_pagar` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Estrutura da tabela `point_transactions`
--
...
--
-- Estrutura da tabela `post_replies`
--
...
--
-- Estrutura da tabela `quiz_scores`
--
...
--
-- Estrutura da tabela `seen_contents`
--
...
--
-- Estrutura da tabela `student_accounts`
--
...
--
-- Estrutura da tabela `subscription_carts`
--
...
--
-- Estrutura da tabela `subscription_courses`
--
...
--
-- Extraindo dados da tabela `subscription_courses`
--
...
--
-- Estrutura da tabela `subscription_course_requests`
--
...
--
-- Extraindo dados da tabela `subscription_course_requests`
--
...
--
-- Estrutura da tabela `subscription_enrollments`
--
...
--
-- Extraindo dados da tabela `subscription_enrollments`
--
...
--
-- Estrutura da tabela `subscription_settings`
--
...
--
-- Extraindo dados da tabela `subscription_settings`
--
...
--
-- Estrutura da tabela `support_ticket_replays`
--
...
--
-- Estrutura da tabela `verify_users`
--
...
--
-- Extraindo dados da tabela `verify_users`
--
...
--
-- Índices para tabela `addons`
--
ALTER TABLE `addons`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `admin_earnings`
--
...
--
-- Índices para tabela `affiliate_payments`
--
ALTER TABLE `affiliate_payments`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `api_password_resets`
--
...
--
-- Índices para tabela `certificate_stores`
--
...
--
-- Índices para tabela `class_contents`
--
...
--
-- Índices para tabela `course_comments`
--
...
--
-- Índices para tabela `course_purchase_histories`
--
...
--
-- Índices para tabela `forum_post_views`
--
ALTER TABLE `forum_post_views`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `helpful_answers`
--
...
--
-- Índices para tabela `instructor_accounts`
--
...
--
-- Índices para tabela `instructor_earnings`
--
...
--
-- Índices para tabela `instructor_subscription_earnings`
--
ALTER TABLE `instructor_subscription_earnings`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `instructor_subscription_payments`
--
...
--
-- Índices para tabela `know_abouts`
--
...
--
-- Índices para tabela `laravel_logger_activity`
--
ALTER TABLE `laravel_logger_activity`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `massages`
--
...
--
-- Índices para tabela `media_managers`
--
...
--
-- Índices para tabela `notification_users`
--
...
--
-- Índices para tabela `package_purchase_histories`
--
...
--
-- Índices para tabela `payments_pagar`
--
ALTER TABLE `payments_pagar`
  ADD PRIMARY KEY (`id`),
  ADD KEY `payments_pagar_user_id_foreign` (`user_id`);
...
--
-- Índices para tabela `point_transactions`
--
...
--
-- Índices para tabela `post_replies`
--
...
--
-- Índices para tabela `quiz_scores`
--
ALTER TABLE `quiz_scores`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `seen_contents`
--
...
--
-- Índices para tabela `student_accounts`
--
...
--
-- Índices para tabela `subscription_carts`
--
ALTER TABLE `subscription_carts`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `subscription_courses`
--
ALTER TABLE `subscription_courses`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `subscription_course_requests`
--
ALTER TABLE `subscription_course_requests`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `subscription_enrollments`
--
ALTER TABLE `subscription_enrollments`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `subscription_settings`
--
...
--
-- Índices para tabela `support_ticket_replays`
--
...
--
-- Índices para tabela `verify_users`
--
...
--
-- AUTO_INCREMENT de tabela `admin_earnings`
--
ALTER TABLE `admin_earnings`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
-- AUTO_INCREMENT de tabela `affiliate_payments`
--
ALTER TABLE `affiliate_payments`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `api_password_resets`
--
ALTER TABLE `api_password_resets`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `certificate_stores`
--
ALTER TABLE `certificate_stores`
...
--
-- AUTO_INCREMENT de tabela `class_contents`
--
ALTER TABLE `class_contents`
...
--
-- AUTO_INCREMENT de tabela `course_comments`
--
ALTER TABLE `course_comments`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de tabela `course_purchase_histories`
--
ALTER TABLE `course_purchase_histories`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
-- AUTO_INCREMENT de tabela `forum_post_views`
--
ALTER TABLE `forum_post_views`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `helpful_answers`
--
ALTER TABLE `helpful_answers`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `instructor_accounts`
--
ALTER TABLE `instructor_accounts`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de tabela `instructor_earnings`
--
ALTER TABLE `instructor_earnings`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de tabela `instructor_subscription_earnings`
--
ALTER TABLE `instructor_subscription_earnings`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `instructor_subscription_payments`
--
ALTER TABLE `instructor_subscription_payments`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
-- AUTO_INCREMENT de tabela `know_abouts`
--
ALTER TABLE `know_abouts`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
-- AUTO_INCREMENT de tabela `laravel_logger_activity`
--
ALTER TABLE `laravel_logger_activity`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4405;

--
-- AUTO_INCREMENT de tabela `massages`
--
ALTER TABLE `massages`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de tabela `media_managers`
--
ALTER TABLE `media_managers`
...
--
-- AUTO_INCREMENT de tabela `notification_users`
--
ALTER TABLE `notification_users`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
-- AUTO_INCREMENT de tabela `package_purchase_histories`
--
ALTER TABLE `package_purchase_histories`
...
--
-- AUTO_INCREMENT de tabela `payments_pagar`
--
ALTER TABLE `payments_pagar`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `point_transactions`
--
ALTER TABLE `point_transactions`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `post_replies`
--
ALTER TABLE `post_replies`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `quiz_scores`
--
ALTER TABLE `quiz_scores`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `seen_contents`
--
ALTER TABLE `seen_contents`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
-- AUTO_INCREMENT de tabela `student_accounts`
--
ALTER TABLE `student_accounts`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `subscription_carts`
--
ALTER TABLE `subscription_carts`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de tabela `subscription_courses`
--
ALTER TABLE `subscription_courses`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de tabela `subscription_course_requests`
--
ALTER TABLE `subscription_course_requests`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de tabela `subscription_enrollments`
--
ALTER TABLE `subscription_enrollments`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de tabela `subscription_settings`
--
ALTER TABLE `subscription_settings`
...
--
-- AUTO_INCREMENT de tabela `support_ticket_replays`
--
ALTER TABLE `support_ticket_replays`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `verify_users`
--
ALTER TABLE `verify_users`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT de tabela `zooms`
--
ALTER TABLE `zooms`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Limitadores para a tabela `class_contents`
--
ALTER TABLE `class_contents`
...
--
-- Limitadores para a tabela `course_comments`
--
ALTER TABLE `course_comments`
...
ALTER TABLE `enrollments`
  ...
  ADD CONSTRAINT `enrollments_payment_id_foreign` FOREIGN KEY (`payment_id`) REFERENCES `payments_pagar` (`id`),
  ADD CONSTRAINT `enrollments_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;

--
-- Limitadores para a tabela `payments_pagar`
--
ALTER TABLE `payments_pagar`
  ADD CONSTRAINT `payments_pagar_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
COMMIT;
